...
const Benefits = () =>{
    return(
        <div className="w-full h-[290px] shadow-xl rounded-xl items-center flex justify-around min-[375px]:flex-col min-[375px]:min-h-[400px] min-[375px]:items-center min-[375px]:w-11/12 min-md:flex-col min-md:w-8/12 min-xl:flex-row min-xl:min-h-[150px] min-xl:w-11/12 min-xl:justify-center min-xl:pl-5">
