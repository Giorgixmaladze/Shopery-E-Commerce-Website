...
const Benefits = () =>{
    return(
        <div className="w-full h-[290px] shadow-xl rounded-xl items-center flex justify-around min-[375px]:flex-col min-[375px]:min-h-[400px] min-[375px]:items-center min-[375px]:w-11/12 min-md:flex-col min-md:w-6/12 ">
