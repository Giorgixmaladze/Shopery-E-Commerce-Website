...
const Deal = () => {
    return (
        <div className="bg-[url('/Home/plants.png')] min-lg:col-start-3 bg-no-repeat bg-cover rounded-2xl overflow-hidden min-[375px]:w-11/12 h-[300px] min-md:h-[500px] min-md:w-12/12 min-lg:row-start-2 min-lg:h-[288px] min-lg:w-[325px] ">
